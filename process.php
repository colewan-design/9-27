...
if(isset($_POST['savePayslip'])){
  ...
  $mysqli->query("INSERT INTO payslipdata (employee_name, from_date, to_date, gross_emp, deduction_emp, nett_emp) VALUES ('$emp_name', '$fromDate', '$toDate', '$emp_gross_amount', '$emp_fetched_difference', '$emp_net_amount')") or
  die($mysqli->error);
