			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li>
							<a href="payslips.php" class="dropdown-toggle no-arrow">
		...
		<div class="main-container">
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
					...
					<div class="card-box mb-30">
						<div class="pd-20 pb-10 d-flex justify-content-center">
							<h4 class="text h4">Payslip Records</h4>
						</div>
						<div style="margin-left: 7px;"class="pd-10 pr-20 d-flex justify-content-start">
							<button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#add-Employee">Generate New Payslip</button>
						</div>
                ...
                <tr>
                    ...
                    <td><?php echo $row['gross_emp']; ?></td>
                    <td><?php echo $row['nett_emp']; ?></td>
                    <td>
